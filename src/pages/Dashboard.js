      ...
      <div className="sidebar" id="sidebar">
        ...
        <div>
          <ul className="nav-links">
            ...
            <li>
              <a href="../Login/login.html" className="active">
                {/* <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  width="15"
                ...
                <div className="content">
                  <div className="task">
                    <p>
                      ...
                      Sint voluptatibus aut culpa tenetur reiciendis deserunt,
                      quam veniam vero, nulla quidem voluptates non. Incidunt
                      maiores quae nesciunt aliquam, non accusamus. Sunt sint ea
                      veniam? Libero dicta, laboriosam asperiores nihil quo
                      velit sequi blanditiis voluptate delectus nulla.
                    </p>
                  </div>
                </div>
              </div>
